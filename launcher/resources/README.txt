KotelDLC launcher resource placeholder.
No credential storage, no bypass logic, no telemetry.
// project note 3: safe scaffold placeholder for local/client-side use only
// project note 4: safe scaffold placeholder for local/client-side use only
// project note 5: safe scaffold placeholder for local/client-side use only
