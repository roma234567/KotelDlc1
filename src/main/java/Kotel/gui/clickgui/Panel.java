...
public class Panel extends Component {
    ...
    public Panel(String label, int x, int y, int width, int height) { super(label, x, y, width, height); }
    public void add(Component component) { children.add(component); }
    public List<Component> getChildren() { return List.copyOf(children); }
    public boolean isExpanded() { return expanded; }
    public void setExpanded(boolean expanded) { this.expanded = expanded; }
    public String renderList() { StringBuilder b=new StringBuilder(describe()).append("\n"); if(expanded) for(Component c:children) b.append(" - ").append(c.describe()).append("\n"); return b.toString(); }
}
