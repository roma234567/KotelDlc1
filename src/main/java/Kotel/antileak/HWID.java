...
public class HWID {
    public String anonymizedLocalLabel() { return "local-development-machine"; }
    public String privacyNotice() { return "This scaffold does not collect or transmit hardware identifiers."; }
    public boolean networkCheckEnabled() { return false; }
}
