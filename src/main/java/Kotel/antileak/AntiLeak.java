...
public class AntiLeak {
    private boolean integrityNoticeShown;
    public void showIntegrityNotice() { integrityNoticeShown = true; System.out.println("KotelDLC integrity notice: no invasive DRM or VM protection is bundled."); }
    public boolean isIntegrityNoticeShown() { return integrityNoticeShown; }
    public String policy() { return "Local-only integrity messaging; no telemetry, no HWID upload, no obfuscation step in this scaffold."; }
}
