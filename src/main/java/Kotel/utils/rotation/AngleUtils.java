...
public final class AngleUtils {
    private AngleUtils() { }
    public static float difference(float a, float b) { return Math.abs(Kotel.utils.rotation.RotationUtils.normalizeYaw(a-b)); }
    public static boolean close(float a, float b, float tolerance) { return difference(a,b) <= tolerance; }
}
