...
public final class RotationUtils {
    ...
    public static float normalizeYaw(float yaw) { while(yaw<=-180) yaw+=360; while(yaw>180) yaw-=360; return yaw; }
    public static float clampPitch(float pitch) { return Math.max(-90, Math.min(90, pitch)); }
}
