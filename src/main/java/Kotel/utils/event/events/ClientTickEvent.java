...
public class ClientTickEvent extends Event {
    ...
    public ClientTickEvent() { this(0L, ""); }
    public ClientTickEvent(long frame, String detail) { this.frame = frame; this.detail = detail == null ? "" : detail; }
    public long getFrame() { return frame; }
    public String getDetail() { return detail; }
    public String describe() { return "ClientTickEvent[frame=" + frame + ", detail=" + detail + "]"; }
}
