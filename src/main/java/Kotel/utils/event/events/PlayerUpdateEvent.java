...
public class PlayerUpdateEvent extends Event {
    ...
    public PlayerUpdateEvent() { this(0L, ""); }
    public PlayerUpdateEvent(long frame, String detail) { this.frame = frame; this.detail = detail == null ? "" : detail; }
    public long getFrame() { return frame; }
    public String getDetail() { return detail; }
    public String describe() { return "PlayerUpdateEvent[frame=" + frame + ", detail=" + detail + "]"; }
}
