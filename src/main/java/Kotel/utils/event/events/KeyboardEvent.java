...
public class KeyboardEvent extends Event {
    ...
    public KeyboardEvent() { this(0L, ""); }
    public KeyboardEvent(long frame, String detail) { this.frame = frame; this.detail = detail == null ? "" : detail; }
    public long getFrame() { return frame; }
    public String getDetail() { return detail; }
    public String describe() { return "KeyboardEvent[frame=" + frame + ", detail=" + detail + "]"; }
}
