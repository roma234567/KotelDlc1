...
public class Render3DEvent extends Event {
    ...
    public Render3DEvent() { this(0L, ""); }
    public Render3DEvent(long frame, String detail) { this.frame = frame; this.detail = detail == null ? "" : detail; }
    public long getFrame() { return frame; }
    public String getDetail() { return detail; }
    public String describe() { return "Render3DEvent[frame=" + frame + ", detail=" + detail + "]"; }
}
