...
public class PacketSendEvent extends Event {
    ...
    public PacketSendEvent() { this(0L, ""); }
    public PacketSendEvent(long frame, String detail) { this.frame = frame; this.detail = detail == null ? "" : detail; }
    public long getFrame() { return frame; }
    public String getDetail() { return detail; }
    public String describe() { return "PacketSendEvent[frame=" + frame + ", detail=" + detail + "]"; }
}
