...
public class Render2DEvent extends Event {
    ...
    public Render2DEvent() { this(0L, ""); }
    public Render2DEvent(long frame, String detail) { this.frame = frame; this.detail = detail == null ? "" : detail; }
    public long getFrame() { return frame; }
    public String getDetail() { return detail; }
    public String describe() { return "Render2DEvent[frame=" + frame + ", detail=" + detail + "]"; }
}
