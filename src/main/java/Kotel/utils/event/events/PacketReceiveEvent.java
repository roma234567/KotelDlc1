...
public class PacketReceiveEvent extends Event {
    ...
    public PacketReceiveEvent() { this(0L, ""); }
    public PacketReceiveEvent(long frame, String detail) { this.frame = frame; this.detail = detail == null ? "" : detail; }
    public long getFrame() { return frame; }
    public String getDetail() { return detail; }
    public String describe() { return "PacketReceiveEvent[frame=" + frame + ", detail=" + detail + "]"; }
}
