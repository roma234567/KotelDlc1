...
public class Event extends Kotel.core.event.Event {
    private String channel = "utils";
    public String getChannel() { return channel; }
    public void setChannel(String channel) { this.channel = channel == null ? "utils" : channel; }
}
