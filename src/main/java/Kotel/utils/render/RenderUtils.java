...
public final class RenderUtils {
    private RenderUtils() { }
    public static String rect(int x, int y, int w, int h, int color) { return "rect("+x+","+y+","+w+","+h+","+color+")"; }
    public static String roundedPanel(String title) { return "rounded-panel:" + title; }
}
