package Kotel.utils.jello;

public final class JelloUtils {
    private JelloUtils() { }
    public static double wave(double time, double speed) { return Math.sin(time * speed); }
    public static double pulse(double time) { return (wave(time, 1.0) + 1.0) / 2.0; }
}
