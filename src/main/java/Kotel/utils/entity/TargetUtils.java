...
public final class TargetUtils {
    private TargetUtils() { }
    public static boolean isAllowedTargetingContext(boolean singlePlayer) { return singlePlayer; }
    public static String explainPolicy() { return "Target helpers are limited to private/single-player contexts."; }
}
