package Kotel.utils.movement;

public final class MovementUtils {
    private MovementUtils() { }
    public static double horizontalSpeed(double x, double z) { return Math.sqrt(x*x + z*z); }
    public static boolean moving(double x, double z) { return horizontalSpeed(x,z) > 0.001; }
}
