...
public enum ModuleCategory {
    ...
    private final boolean fairPlayByDefault;
    ModuleCategory(String displayName, boolean fairPlayByDefault) { this.displayName=displayName; this.fairPlayByDefault=fairPlayByDefault; }
    public String getDisplayName() { return displayName; }
    public boolean isFairPlayByDefault() { return fairPlayByDefault; }
}
